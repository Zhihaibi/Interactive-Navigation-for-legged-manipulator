...
python train.py --headless --exptid 1230_exp1 --proj_name b2z1-low --task b2z1 --sim_device cuda:0 --rl_device cuda:0 --observe_gait_commands --resume
...
python play.py --exptid b2_z1_V1 --task b2z1 --proj_name b2z1-low --checkpoint 46000 --observe_gait_commands
```
